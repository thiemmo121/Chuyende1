...
<head>
    ...
    <title>@yield('title', 'Laravel Assignment')</title>
...
<body>
    <nav class="site-navbar">
        <div class="container nav-panel navbar navbar-expand-lg navbar-light px-lg-5">
            <a class="navbar-brand brand-link" data-text="Dũng Nguyễn" href="{{ route('dashboard') }}">
                <span>ThiemMo</span>
            </a>
            ...
            <div class="collapse navbar-collapse" id="mainNav">
                <ul class="navbar-nav ms-auto gap-lg-1">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('appointments.index') }}">Đặt lịch</a></li>
                </ul>
            </div>
        </div>
    </nav>
